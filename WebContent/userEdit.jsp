...
<form method="post" action="userControl"><input type="hidden" name="action" value="update"/>
	<table border="0" cellpadding="3">
		<thead>
			<tr>
				<th colspan="2" align='left'><h1>Edit User</h1></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td align='right'>Username</td>
				<td><input type="text" name="username" value="${target.username}" readonly/></td>
			</tr>
			<tr>
